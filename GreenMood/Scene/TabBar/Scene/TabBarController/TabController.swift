...
class TabController: UITabBarController, UITabBarControllerDelegate {
    ...
    func setupMiddleButton() {
        ...
        middleBtn.setImage(UIImage(named: "saffron"), for: .normal)
    ...
    @objc func discoverButtonAction(sender: UIButton) {
        ...
        //        let controller = storyboard?.instantiateViewController(identifier: "SpecialController") as! SpecialController
